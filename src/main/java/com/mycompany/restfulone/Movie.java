...
public class Movie {
     ...
     * duration format
     */
    @XmlJavaTypeAdapter(com.mycompany.restfulone.DurationAdapter.class)
    ...
    @XmlJavaTypeAdapter(com.mycompany.restfulone.LocalTimeAdapter.class)
    private LocalTime[] showingon;
    @XmlJavaTypeAdapter(com.mycompany.restfulone.ReleasedAdapter.class)
