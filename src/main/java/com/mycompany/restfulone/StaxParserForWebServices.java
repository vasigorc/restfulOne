...
@Named
@RequestScoped
public class StaxParserForWebServices implements Serializable {
    ...
    public StaxParserForWebServices() throws IOException {
        ...
        InputStream input = new FileInputStream(new File("C:\\Users\\vasigorc\\Documents\\NetBeansProjects\\RestfulOne\\src\\main\\java\\com\\mycompany\\restfulone\\simplemovies.xml"));
        try {
